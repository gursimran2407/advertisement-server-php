...
if(isset($_POST['sub']))
{
	...
	if (!empty($_POST['email'])) {
		$email= $_POST['email'];
		$insert = "UPDATE client SET email='$email' WHERE id='$chkid'";
        $insert2 = "UPDATE click_count SET client_email='$email' WHERE client_email='$chkemail'";
	...
	if (!empty($_POST['pass'])) {
		$pass = $_POST['pass'];
		$passmd = md5($pass);
		$insert2 = "UPDATE client SET password='$passmd' WHERE id='$chkid'";
		$query2 = mysqli_query($conn, $insert2);
	}
